// original shader by Klems
// https://www.shadertoy.com/view/ltSSzW
// ported to Balatro by stupxd
// (from POLTERWORX)
// tweaked by Meta
...
vec4 effect(vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords)
{
  ...
  float pixel_size = 0.75 / max(texture_details.z, texture_details.a);
  bool dithering = getValue(hsl.z, uv, pixel_size);

  vec4 final_tex = vec4(vec3(!dithering), tex.a);
